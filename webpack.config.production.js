...
module.exports = {
    ...
    output: {
        ...
        // path to our cuurent directory. Then with 'path.resolve' we
        // join directories
        // Webpac 4 assumes ypur output path will be './dist' so you
        // can just leave this
        // entry out.
    ...
    plugins: [
        ...
        // Cresate the stylesheet under 'styles' directory
